...
<button onclick="window.location.href='index.html';" class="btn btn-outline-danger my-2 my-sm-0" type="submit">Logout</button>
    ...
    <%
        Class.forName("com.mysql.jdbc.Driver");
                ...
                String query3 = "SELECT (@row_number:=@row_number + 1) AS num,customerUsername,reservationID,hotelName,reservationDate,CheckIn,CheckOut FROM fondok.reservations";
